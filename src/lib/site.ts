...
const seoKeywords = uniqueStrings([
  ...
  "Federico Shop online record shop",
  "Federico Shop Berlin record shop",
  "Federico Shop electronic music store",
  "Federico Shop records tapes CDs",
  "Berlin record shop",
  "Berlin vinyl store",
  ...
  "techno vinyl online",
  "used techno vinyl online",
  "electro vinyl",
  "electro records Berlin",
  "electro vinyl online",
  "EBM records",
  "EBM records Berlin",
  "EBM vinyl online",
  "darkwave vinyl",
  "darkwave records Berlin",
  "darkwave records online",
  "ambient records",
  "ambient vinyl Berlin",
  "post-punk records",
  "post-punk vinyl Berlin",
  "post-punk records online",
  "buy vinyl online Berlin",
  "buy records online Berlin",
  "Berlin local pickup records",
  "Berlin Neukolln local pickup records",
  ...
  "gebrauchte Techno Schallplatten",
  ...
  "tienda de discos online Berlin",
...
const seoKeywordText = seoKeywords.slice(0, 40).join(", ");
