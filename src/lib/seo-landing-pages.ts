    ...
    faqs: [
      {
        ...
        answer:
          "Pickup is arranged in Berlin Neukolln at Federico Shop after you place the order and receive the confirmation email.",
      },
      {
        question: "How do I choose local pickup?",
        answer:
          "Add records to the cart, complete the checkout details, and choose the local pickup option before placing the order.",
      },
      {
        question: "When do I get pickup details?",
        answer:
          "After the order is received, Federico Shop sends a confirmation email with the pickup confirmation and details.",
      },
    ],
  },
];
