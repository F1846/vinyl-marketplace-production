  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <div className="space-y-3">
        ...
        <h1 className="font-serif text-4xl text-foreground">Terms and Conditions</h1>
      ...
      <section className="card space-y-3 text-sm leading-7 text-muted">
        <h2 className="font-serif text-2xl text-foreground">Product Condition</h2>
        <p>
      ...
      <section className="card space-y-3 text-sm leading-7 text-muted">
        <h2 className="font-serif text-2xl text-foreground">Orders and Payment</h2>
        <p>
